...
Dependencies are defined in the `pyproject.toml` file, as officially recommended by the Python packaging authority (see `Writing your pyproject.toml <https://packaging.python.org/en/latest/guides/writing-pyproject-toml/>`_).
...
- `qt`: Qt-based graphical user interface (for interactive testing purposes).
